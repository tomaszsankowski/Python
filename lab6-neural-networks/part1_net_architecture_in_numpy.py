...
def zad2_two_layer_net(student_id):
    ...
    model.hidden_layer.W[:, 0] = [0.0, 0.1]      # wagi neuronu h1
    model.hidden_layer.W[:, 1] = [0.0, -0.1]     # wagi neuronu h2
    model.hidden_layer.b[:] = [-0.01, 0.08]         # biasy neuronów h1 i h2
    model.output_layer.W[:, 0] = [0.15, 0.2]      # wagi neuronu wyjściowego
    model.output_layer.b[:] = -0.25        # bias neuronu wyjściowego
...
if __name__ == '__main__':
    ...
    student_id = 193363  # Twój numer indeksu, np. 102247
